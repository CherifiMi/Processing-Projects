...
public class stringart extends PApplet {
 ...
 */
 public void drawLine() {
  ...
  public void settings() { size(1336, 1000); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "stringart" };
    if (passedArgs != null) {
