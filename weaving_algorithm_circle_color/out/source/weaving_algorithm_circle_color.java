...
public class weaving_algorithm_circle_color extends PApplet {
 ...
 */
 ...
 public void setAverageColorBackground() {
 ...
 public WeavingThread addLine(int c,String name) {
 ...
 */
 public void drawLine(WeavingThread wt) {
  int i, j, k;
 ...
 public float scoreLine(int i,int nextPoint,WeavingThread wt) {
 ...
 public float dtm(float fx,float fy) {
  float dx=fx - img.width/2;
  float dy=fy - img.height/2;
  return (1.0f- (sqrt(dx*dx +dy*dy)/(img.width/2)))*5;
}

 public float scoreColors(int a,int b) {
 ...
 public void drawToDest(int start, int end, int c) {
  ...
  public void settings() { size(1472, 741); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "weaving_algorithm_circle_color" };
    if (passedArgs != null) {
